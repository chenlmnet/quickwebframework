...
public class Mail {
     ...
     */
    public HashMap send() throws GeneralSecurityException {
...
//        store.connect(IMAP_HOST_NAME, SMTP_AUTH_USERNAME, SMTP_AUTH_PWD);    
//        inbox = store.getFolder(DEFAULT_MBOX_NAME);         
//        inbox.open(Folder.READ_ONLY); 
    ...
    public static void main(String[] args) throws GeneralSecurityException {
        ...
        m.setContent("abcdef");
        m.setDisplayName("张三");
//        m.setFrom("sh_lishuai@163.com");
//        m.setFrom("zs@sipspf.org.cn");
        m.setFrom("chenlmncut@163.com");
        m.setIfAuth(true);
        //m.setPassword("wsgylsa");
//        m.setPassword("123456");
        m.setUserName("chenlmncut");
        m.setPassword("874128523M");
        m.setSmtpServer("smtp.163.com");
//        m.setSmtpServer("expfmc.sipspf.org.cn");
        m.setSubject("bbbbbb");
        m.setTo("chenlmnet@163.com");

        //	m.addAttachfile("D:\\test.jpg");
        m.send();
    }

    //http://joeblow.iteye.com/blog/756363
